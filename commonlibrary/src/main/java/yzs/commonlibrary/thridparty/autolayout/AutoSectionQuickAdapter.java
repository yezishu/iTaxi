...
public abstract class AutoSectionQuickAdapter<T extends SectionEntity, K extends AutoViewHolder>
        extends AutoQuickAdapter<T, K> {
     ...
     */
    public AutoSectionQuickAdapter( int layoutResId, int sectionHeadResId, List<T> data) {
